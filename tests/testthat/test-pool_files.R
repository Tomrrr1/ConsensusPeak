test_that("Correct number of output files when no control has been passed", {
  ...
  test_list <- list("treatment_file_1" = testthat::test_path("testdata",
                                                             "r1_test.bam"),
                    "treatment_file_2" = testthat::test_path("testdata",
                                                             "r2_test.bam"),
                    "control_file_1" = testthat::test_path("testdata",
                                                           "r1_test.bam"),
                    "control_file_2" = testthat::test_path("testdata",
                                                           "r2_test.bam"))
